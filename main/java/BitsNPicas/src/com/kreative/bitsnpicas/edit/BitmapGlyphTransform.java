...
public abstract class BitmapGlyphTransform {
	...
	public static final BitmapGlyphTransform[] TRANSFORMS = new BitmapGlyphTransform[] {
		new Bold          ("加粗",            CTRL_SHIFT, KeyEvent.VK_B),
		new Invert        ("反转",          CTRL_SHIFT, KeyEvent.VK_N),
		new FlipHorizontal("水平翻转", CTRL_SHIFT, KeyEvent.VK_H),
		new FlipVertical  ("竖直翻转",   CTRL_SHIFT, KeyEvent.VK_J),
		null,
		new Nudge(-1, 0, "左移",  CTRL_SHIFT, KeyEvent.VK_LEFT ),
		new Nudge(+1, 0, "右移", CTRL_SHIFT, KeyEvent.VK_RIGHT),
		new Nudge(0, -1, "上移",    CTRL_SHIFT, KeyEvent.VK_UP   ),
		new Nudge(0, +1, "下移",  CTRL_SHIFT, KeyEvent.VK_DOWN ),
	};
